...
# 2. Add the columns back to myData
...
# Then run the histograms
par(mfrow = c(1, 2))

hist(mars_data$Duration, col = "red", main = "Mars")
hist(venus_data$Duration, col = "blue", main = "Venus")
