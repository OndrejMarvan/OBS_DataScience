...
*Cluster 4 (Purple):* The Isolated Gas Economy. I found only Iran in this cluster. I interpret this as unique case - country with huge gas reserves but cut off from global markets by sanctions, creating different energy pattern.
Cluster 5 (Orange): The Russian Energy Model. Only Russia belongs here. I define this cluster by massive fossil fuel exports combined with cold climate that needs enormous heating energy. It is outlier because of its size and role as world's major gas supplier.
...
# Prepare map data for 2023 clusters
