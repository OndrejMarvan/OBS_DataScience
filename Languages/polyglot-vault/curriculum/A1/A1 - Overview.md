...
## Goal
Understand and use familiar everyday expressions and very basic phrases. Introduce yourself, ask and answer questions about personal details. Interact in a simple way.
...
- [[A1-01 Greetings and Introductions]]
- Saying hello, goodbye, please, thank you
- Introducing yourself (name, nationality, language)
- **Words:** ~40 (cześć/cześć, dzień dobry, do widzenia, tak, nie, proszę, dziękuję...)

### Unit 2 — Numbers, Time, Calendar
- [[A1-02 Numbers and Time]]
- Numbers 0–100
- Days of the week, months
- Telling time, basic dates
- **Words:** ~60

### Unit 3 — Family and People
- [[A1-03 Family and People]]
- Family members, relationships
- Describing people (age, appearance basics)
- Professions (basic)
- **Words:** ~50

### Unit 4 — At Home
- [[A1-04 Home and Living]]
...
- Common foods, drinks, meals
- At a restaurant / café (ordering)
- **Words:** ~60

### Unit 6 — Daily Routine
- [[A1-06 Daily Routine]]
- Actions throughout the day
- Time expressions (ráno/rano, večer/wieczorem)
- **Words:** ~40
...
> **Watch out:** Different conjugation endings (-ę/-esz in PL vs -u/-eš in CZ), different soft consonant system, nasal vowels ą/ę.
