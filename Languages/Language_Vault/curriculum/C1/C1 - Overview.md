...
**Vocabulary target:** ~7000+ words (cumulative)
...
> **Key advantage:** You can compare how Polish, Czech, German, English, and Russian each handle the same rhetorical strategy — this deepens understanding of all five simultaneously.
> **Reading across languages:** At this level, read parallel texts (news articles on the same event in PL, CZ, DE, EN, RU) to see how each language frames the same content.

---
**Previous:** [[B2 - Overview]]

## Completion Checklist
- [ ] Can understand long, complex texts with implicit meaning
- [ ] Can express ideas fluently without searching for words
- [ ] Can use language flexibly for professional and academic purposes
- [ ] Can produce well-structured, detailed text on complex subjects
- [ ] Can navigate humor, irony, and cultural references
- [ ] 7000+ active vocabulary words
